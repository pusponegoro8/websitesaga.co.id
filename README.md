...
- ✅ Proyek dinamis dari JSON
- ✅ Contact form (simulasi - siap EmailJS)
- ✅ Download resume
...
git init
git add .
git commit -m "Initial website pribadi"
git branch -M main
git remote add origin https://github.com/[username]/[repo].git
git push -u origin main
gh repo deploy --repo [username]/[repo] --branch main
```
